  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Hasil Rekomendasi", style: TextStyle(color: Colors.white)),
        centerTitle: true,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildCard("Estimasi Ukuran Tubuh Anak", [
                    ...
                    if (actualSizeData != null) ...[
                      _buildCard("Detail Ukuran Baju ($rekomendasiStatus)", [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Text("Cek Produk Lain", style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                    ),
                  ],
                ),
