...
class _EditPakaianPageState extends State<EditPakaianPage> {
  ...
  void initState() {
    ...
    _usiaMinController = TextEditingController(
      text: _angka(data['usiaMinBulan']),
    );
    _usiaMaxController = TextEditingController(
      text: _angka(data['usiaMaxBulan']),
    );
  ...
  Future<void> _simpan() async {
    ...
    for (final item in _ukuran) {
      ...
      if (ukuranItem == null) {
        _pesan(
          'Setiap ukuran harus memiliki nama, lebar dada, dan panjang baju lebih dari 0.',
        );
        return;
      }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _dropdown(
                            ...
                            _genderPakaian,
                            _gender,
                            (value) => setState(() => _genderPakaian = value),
                          ),
                          const SizedBox(height: 16),
                          const Text(
                            'Rentang Usia Target',
                          ...
                          ..._ukuran.asMap().entries.map(
                            (entry) => _ukuranCard(entry.key, entry.value),
                          ),
                          SizedBox(
                            width: double.infinity,
                            child: OutlinedButton.icon(
                              onPressed: () => setState(
                                () => _ukuran.add(_UkuranController()),
                              ),
                              ...
                              style: OutlinedButton.styleFrom(
                                ...
                                side: const BorderSide(
                                  color: Color.fromARGB(255, 76, 56, 0),
                                ),
      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            IconButton(
              onPressed: _ukuran.length == 1
                  ? null
                  : () => setState(() {
                      final removed = _ukuran.removeAt(index);
                      removed.dispose();
                    }),
              icon: const Icon(Icons.delete_outline, color: Color(0xFFB88700)),
            ),
          ],
        ),
        ...
        Row(
          children: [
            Expanded(child: _field('Lebar Dada', item.lebarDada, angka: true)),
            const SizedBox(width: 12),
            Expanded(
              child: _field('Panjang Baju', item.panjangBaju, angka: true),
            ),
          ],
        ),
      ],
